...
local function validate_file_name(arg)
...
---@useage: :LOGOpen [N]   (opens nvim-N.log, default opens nvim.log)
vim.api.nvim_create_user_command("LOGOpen", function(opts)
	local name = validate_file_name(opts.args)
	if name then
...
---@useage: :LOGLast [N]   (returns last log message from nvim log file.)
