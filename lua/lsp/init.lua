...
M.setup = function()
	...
	local function lsp_keymaps(bufnr)
		...
		set("n", "<leader>lb", "<cmd>Telescope diagnostics bufnr=0<CR>", "Show buffer diagnostics")
		...
		set("n", "<leader>lc", vim.lsp.buf.hover, "Show documentation for what is under cursor")
