...
M.setup = function()
	...
	local function lsp_keymaps(bufnr)
		...
		set("n", "<leader>ir", "<cmd>Telescope lsp_references<CR>", "Show LSP references")
		set("n", "<leader>ig", vim.lsp.buf.declaration, "Go to declaration")
		set("n", "<leader>id", "<cmd>Telescope lsp_definitions<CR>", "Show LSP definitions")
		set("n", "<leader>ii", "<cmd>Telescope lsp_implementations<CR>", "Show LSP implementations")
		set("n", "<leader>it", "<cmd>Telescope lsp_type_definitions<CR>", "Show LSP type definitions")
		set("n", "<leader>ib", "<cmd>Telescope diagnostics bufnr=0<CR>", "Show buffer diagnostics")
		set("n", "<leader>il", vim.diagnostic.open_float, "Show line diagnostics")
		set("n", "<leader>ip", function()
			vim.diagnostic.jump({ count = -1, border = "rounded" })
		end, "Go to previous diagnostic")
		set("n", "<leader>in", function()
			vim.diagnostic.jump({ count = 1, border = "rounded" })
		end, "Go to next diagnostic")
		set("n", "<leader>ic", vim.lsp.buf.hover, "Show documentation for what is under cursor")
		set({ "n", "v" }, "<leader>ia", vim.lsp.buf.code_action, "See available code actions")
